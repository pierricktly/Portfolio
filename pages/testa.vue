<template>
<div>
  <div class="scroll-smooth snap-y snap-proximity divide-y divide-white/10 overflow-y-scroll h-screen w-screen flex flex-col text-white lg:text-xl">
    <section id="home" class="snap-start shrink-0 w-full min-h-screen mx-auto p-5 lg:p-0 flex flex-col justify-center items-center space-y-10 lg:space-y-14">
      ...
      <div class="space-x-5 text-xl w-full flex justify-center">
    ...
    <section id="about" class="snap-start shrink-0 w-full min-h-screen mx-auto p-5 lg:p-0 flex flex-col justify-center items-center space-y-10 lg:space-y-14">
      <div class="w-full flex justify-center">
        <img alt="Profile picture" src="../assets/images/profile_picture.png" class="bg-gray-500 w-48 lg:w-80 rounded-full aspect-square"/>
      </div>
      <div class="w-full flex justify-center">
      ...
      <div class="w-full flex justify-center">
        <p class="text-center whitespace-pre-line leading-loose md:text-xl lg:text-2xl xl:text-3xl max-w-2xl">
    ...
    <section id="portfolio" class="snap-start shrink-0 w-full min-h-screen mx-auto p-5 lg:p-0 flex flex-col justify-center items-center space-y-10 lg:space-y-14">
    ...
    <section id="contact" class="snap-start shrink-0 w-full min-h-screen mx-auto p-5 lg:p-0 flex flex-col justify-center items-center space-y-10 lg:space-y-14">
