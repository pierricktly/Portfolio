<template>
	<div class="text-white">
			...
			<div class="container flex my-auto mx-auto">
				<div class="my-auto space-y-10">
					<div>
						...
						>
							Hi,<br />I'm
							<span class="text-secondary font-semibold">Pierrick</span>,<br />a
							frontend developer
						</p>
					</div>
					<div>
		...
		<page-section
			class="bg-[#17202C] border-y border-primary/50 shadow-inner mt-14"
		>
			<template #title> My Stack </template>
			<template>
				<div class="space-y-10">
					<category-stack
						...
						:stack-list="category.stacks"
					/>
				</div>
			</template>
		</page-section>
		<div class="container mx-auto divide-y divide-slate-700/90">
			<page-section>
			...
			<page-section>
				...
				<div class="my-52 text-center mx-auto">
					<button
						type="button"
						@click="copyEmail()"
						class="font-bold text-4xl md:text-6xl lg:text-7xl xl:text-9xl hover-underline-animation"
					>
						Click here to copy
					</button>
				</div>
