  ...
  <div>
    <div data-scroll-container class="overflow-y-scroll flex flex-col text-white lg:text-xl overflow-x-hidden">
      ...
      <section id="about" data-scroll-section class="w-full min-h-screen mx-auto relative p-5 lg:p-0 flex flex-col justify-center items-center">
        <div class="flex flex-col items-center space-y-10 md:space-y-0">
        ...
        <div id="direction" class="hidden 2xl:flex flex-col justify-center items-center absolute top-0 bottom-0 left-0 right-0 h-screen w-screen">
